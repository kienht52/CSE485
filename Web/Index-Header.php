...
<body>
	<div class="home">
		<header class="head head-desktop">
			<div class="wrapper row top_head">
				...
				<div class="col-md-6 ">
                    ...
                    <a class="col" href="Login.php">LOGIN</a>
				</div>
			...
			<div class="menu">
				...
				<div class="wrapper">
					<nav class="navbar navbar-expand-lg">
						<a href="Index.php"><img src="./img/logo_ntt.png"></a>
					  ...
					  <div class="collapse navbar-collapse row" id="navbarNav">
					    <ul class="navbar-nav ">
					      <li class="nav-item col" style="font-size: 15px">
					        <a class="nav-link" href="#"><i class="fa fa-info-circle"></i> Giới thiệu</a>
					      </li>
					      <li class="nav-item col"style="font-size: 15px">
					        <a class="nav-link" href="#"><i class="fa fa-graduation-cap"></i> Tuyển sinh</a>
					      </li>
					      <li class="nav-item col"style="font-size: 15px">
					        <a class="nav-link" href="#"><i class="fa fa-book"></i> Đào tạo</a>
					      </li>
					      <li class="nav-item col"style="font-size: 15px">
					        <a class="nav-link" href="#"><i class="fa fa-bookmark"></i> Nghiên cứu</a>
					      </li>
					      <li class="nav-item col-3"style="font-size: 15px">
					        <a class="nav-link" href="#"><i class="fas fa-handshake"></i> Hợp tác doanh nghiệp</a>
					      </li>
					    </ul>
					  </div>
					</nav>
